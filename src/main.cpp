...
const string strMessageMagic = "duly Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 56010000)
    {
        nSubsidy = 5 * COIN;
    }
...
// duly: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "duly", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Thedully";
        CTransaction txNew;
        txNew.nTime = 1513014076;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3fdbbcbc09c8cb75fb97a3e4f2ac5e1c6b1da2b35fb0385ea40f05e8bc361de7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xc2, 0xf1, 0xd1 };
